...
export const projectsData: Project[] = [
  {
    title: "Grant Agencji Badań Medycznych: Non-commercial, randomized clinical trial evaluating the efficacy of 1-8-cyneol (18C) in the treatment of MRSA nasal carriage (NOSE).",
    ...
    roles: [
      { academicTitle: "dr hab.", name: "Adam Junka", universityTitle: "prof. UMW", role: "Kierownik zadań laboratoryjnych mikrobiologicznych" },
      { academicTitle: "dr", name: "Malwina Brożyna", role: "Wykonawca zadań laboratoryjnych mikrobiologicznych" },
      { academicTitle: "dr", name: "Bartłomiej Dudek", role: "Wykonawca zadań laboratoryjnych mikrobiologicznych" },
    ],
  ...
  {
    title: "Grant Narodowego Centrum Badań i Rozwoju Lider XIII: Staphix – innowacyjne rozwiązania na bazie bakteriocyn do kontroli mikrobiomu skóry i błon śluzowych w weterynarii.",
    ...
    roles: [
      { academicTitle: "dr hab.", name: "Adam Junka", universityTitle: "prof. UMW", role: "Ekspert" },
  ...
  {
    title: "Grant Narodowego Centrum Nauki Preludium: Ocena aktywności przeciwbiofilmowej olejków eterycznych wobec drobnoustrojów izolowanych z zakażeń ran przewlekłych przeprowadzona w środowisku odzwierciedlającym środowisko rany przewlekłej.",
    ...
    roles: [
      ...
      { academicTitle: "dr hab.", name: "Adam Junka", universityTitle: "prof. UMW", role: "Opiekun projektu" },
    ],
