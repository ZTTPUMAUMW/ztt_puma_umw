...
export const projectsData: Project[] = [
  {
    title: "Medical Research Agency Grant: Non-commercial, randomized clinical trial evaluating the efficacy of 1-8-cineol (18C) in the treatment of MRSA nasal carriage (NOSE).",
    ...
    roles: [
      { academicTitle: "Dr. habil.", name: "Adam Junka", universityTitle: "Professor at UMW", role: "Head of microbiological laboratory tasks" },
      { academicTitle: "PhD", name: "Malwina Bro\u017cyna", role: "Performer of microbiological laboratory tasks" },
      { academicTitle: "PhD", name: "Bart\u0142omiej Dudek", role: "Performer of microbiological laboratory tasks" },
    ],
  ...
  {
    title: "National Centre for Research and Development Lider XIII Grant: Staphix – innovative bacteriocin-based solutions for controlling skin and mucous membrane microbiome in veterinary medicine.",
    ...
    roles: [
      { academicTitle: "Dr. habil.", name: "Adam Junka", universityTitle: "Professor at UMW", role: "Expert" },
  ...
  {
    title: "National Science Centre Preludium Grant: Evaluation of antibiofilm activity of essential oils against microorganisms isolated from chronic wound infections, conducted in an environment reflecting the chronic wound environment.",
    ...
    roles: [
      ...
      { academicTitle: "Dr. habil.", name: "Adam Junka", universityTitle: "Professor at UMW", role: "Project supervisor" },
    ],
