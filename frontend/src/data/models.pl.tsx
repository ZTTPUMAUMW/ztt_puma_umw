...
export const modelsData: ModelData[] = [
  {
    ...
    description: (
      <>
        Bezkręgowy organizm modelowy wykorzystywany w badaniach <i>in vivo</i>, między innymi w
        zakresie toksykologicznym, mikrobiologicznym oraz behavioralnym. W ciągu dwóch lat pracy na
        organizmie, doprowadziliśmy do dwóch zgłoszeń patentowych:
  ...
  },
  {
    ...
    description:
      "Żywy system do badań nad sieciami, algorytmami i adaptacją, zjawiskami emergentnymi.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Narzędzie do badania wpływu czynników fizycznych na mikroorganizmy i materiały, w tym efektów addytywnych i synergistycznych w zwalczaniu wielolekooporności.",
  },
  {
  ...
  },
  {
    ...
    title: "Twój model",
    description:
      "Masz pomysł, którego nikt jeszcze nie testował? My go zbudujemy! Uwielbiamy tworzyć narzędzia, które otwierają nowe możliwości badawcze.",
  },
];
