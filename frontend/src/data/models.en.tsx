...
export const modelsData: ModelData[] = [
  {
    ...
    description: (
      <>
        An invertebrate model organism used in <i>in vivo</i> research, including toxicological, microbiological, and behavioral studies. During two years of work with this organism, we have made two patent applications:
  ...
  },
  {
    ...
    description: "A living system for research on networks, algorithms and adaptation, emergent phenomena.",
  },
  {
  ...
  },
  {
    ...
    description: "A tool for studying the impact of physical factors on microorganisms and materials, including additive and synergistic effects in combating multidrug resistance.",
  },
  {
  ...
  },
  {
    ...
    title: "Your model",
    description: "Have an idea that no one has tested yet? We'll build it! We love creating tools that open up new research possibilities.",
  },
];
