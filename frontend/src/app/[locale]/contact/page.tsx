          ...
          <div className={styles['contact-main-grid']}>
            ...
            <div className={styles['contact-info-column']}>
              ...
              <div className={styles['contact-box']}>
                ...
                <p className={styles['contact-box-line']}><strong>{t('address.department')}</strong></p>
                <p className={styles['contact-box-line']}><strong>{t('address.lab')}</strong></p>
                <p className={styles['contact-box-line']}><strong>{t('address.faculty')}</strong></p>
                <p className={styles['contact-box-line']}><strong>{t('address.university')}</strong></p>
                

                <p className={styles['contact-box-line']}>{t('address.street')}</p>
                <p className={`${styles['contact-box-line']} ${styles['contact-box-line-light']}`}>{t('address.floor')}</p>
              </div>
              ...
              <div className={styles['contact-box']}>
                ...
                <p className={styles['contact-box-line']}>
                  <a href="tel:+48717840471" className={styles['contact-box-link']}>(71) 78-40-471</a>
                </p>
              </div>
              ...
              <div className={styles['contact-box']}>
                ...
                <p className={styles['contact-box-line']}>
                  <a href="mailto:WF-30@umw.edu.pl" className={styles['contact-box-link']}>WF-30@umw.edu.pl</a>
                </p>
              </div>
            </div>
