  ...
  return (
    <section className={styles['feature-boxes']}>
      <div className={styles['feature-boxes__container']}>
        ...
        <p className={styles['feature-boxes__subtitle']}>
          {t('subtitle')}
        </p>
        <div className={styles['feature-boxes__grid']}>
          {features.map((feature, index) => (
            <div key={index} className={styles['feature-boxes__box']}>
              <h3 className={styles['feature-boxes__box-title']}>{t(`items.${feature.key}.title`)}</h3>
              <p className={styles['feature-boxes__box-description']}>{t(`items.${feature.key}.description`)}</p>
            </div>
          ))}
        </div>
        <p className={styles['feature-boxes__closing']}>
          {t('closing')}
        </p>
      </div>
    </section>
