...
export default function FeaturedBanner({ image, title, description, link, alt }: FeaturedBannerProps) {
          ...
          <div className={styles.banner__content}>
            ...
            <a href={link} target="_blank" rel="noopener noreferrer" className={styles.banner__cta}>
              ...
              <svg width="20" height="12" viewBox="0 0 20 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14 1L19 6L14 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
